...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 2.0, "minX": 0.0, "maxY": 997.0, "series": [{"data": [[0.0, 997.0], [100.0, 3.0]], "isOverall": false, "label": "Checkout", "isController": false}, {"data": [[0.0, 993.0], [100.0, 7.0]], "isOverall": false, "label": "Add to Cart", "isController": false}, {"data": [[0.0, 988.0], [100.0, 10.0], [200.0, 2.0]], "isOverall": false, "label": "Transaction Controller", "isController": true}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 200.0, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.369333333333336, "minX": 1.76400216E12, "maxY": 1.369333333333336, "series": [{"data": [[1.76400216E12, 1.369333333333336]], "isOverall": false, "label": "Scenario 1", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76400216E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 2.3875802997858657, "minX": 1.0, "maxY": 213.0, "series": [{"data": [[8.0, 54.0], [2.0, 4.594594594594594], [9.0, 20.0], [10.0, 19.0], [11.0, 46.0], [12.0, 30.0], [3.0, 12.5], [13.0, 22.0], [14.0, 38.5], [15.0, 91.0], [16.0, 99.0], [4.0, 104.0], [1.0, 2.3875802997858657], [17.0, 41.6], [18.0, 18.0], [5.0, 116.0], [6.0, 81.0], [7.0, 10.0]], "isOverall": false, "label": "Checkout", "isController": false}, {"data": [[1.3440000000000005, 3.817999999999994]], "isOverall": false, "label": "Checkout-Aggregated", "isController": false}, {"data": [[16.0, 20.6], [4.0, 5.0], [1.0, 3.780765253360909], [2.0, 7.0], [17.0, 65.85714285714286], [18.0, 85.83333333333334], [9.0, 5.0], [5.0, 5.0], [11.0, 7.0], [14.0, 43.0], [7.0, 7.0], [15.0, 5.0]], "isOverall": false, "label": "Add to Cart", "isController": false}, {"data": [[1.4150000000000007, 5.0479999999999965]], "isOverall": false, "label": "Add to Cart-Aggregated", "isController": false}, {"data": [[8.0, 82.0], [2.0, 9.976190476190478], [9.0, 28.0], [10.0, 24.0], [11.0, 64.0], [12.0, 53.0], [3.0, 18.5], [13.0, 41.0], [14.0, 118.0], [15.0, 114.0], [16.0, 155.5], [4.0, 213.0], [1.0, 6.095801937567274], [17.0, 96.6], [18.0, 78.66666666666667], [5.0, 178.5], [6.0, 199.0], [7.0, 15.0]], "isOverall": false, "label": "Transaction Controller", "isController": true}, {"data": [[1.3490000000000006, 8.866000000000021]], "isOverall": false, "label": "Transaction Controller-Aggregated", "isController": true}], "supportsControllersDiscrimination": true, "maxX": 18.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 12028.216666666667, "minX": 1.76400216E12, "maxY": 13829.766666666666, "series": [{"data": [[1.76400216E12, 12028.216666666667]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.76400216E12, 13829.766666666666]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76400216E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 3.817999999999994, "minX": 1.76400216E12, "maxY": 8.866000000000021, "series": [{"data": [[1.76400216E12, 3.817999999999994]], "isOverall": false, "label": "Checkout", "isController": false}, {"data": [[1.76400216E12, 5.0479999999999965]], "isOverall": false, "label": "Add to Cart", "isController": false}, {"data": [[1.76400216E12, 8.866000000000021]], "isOverall": false, "label": "Transaction Controller", "isController": true}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76400216E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.76400216E12, "maxY": 5.000999999999992, "series": [{"data": [[1.76400216E12, 3.795000000000002]], "isOverall": false, "label": "Checkout", "isController": false}, {"data": [[1.76400216E12, 5.000999999999992]], "isOverall": false, "label": "Add to Cart", "isController": false}, {"data": [[1.76400216E12, 0.0]], "isOverall": false, "label": "Transaction Controller", "isController": true}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76400216E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.76400216E12, "maxY": 0.6209999999999996, "series": [{"data": [[1.76400216E12, 0.0]], "isOverall": false, "label": "Checkout", "isController": false}, {"data": [[1.76400216E12, 0.6209999999999996]], "isOverall": false, "label": "Add to Cart", "isController": false}, {"data": [[1.76400216E12, 0.6209999999999996]], "isOverall": false, "label": "Transaction Controller", "isController": true}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76400216E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimePercentilesOverTimeInfos = {
        data: {"result": {"minY": 3.0, "minX": 1.76400216E12, "maxY": 152.0, "series": [{"data": [[1.76400216E12, 152.0]], "isOverall": false, "label": "Max", "isController": false}, {"data": [[1.76400216E12, 5.0]], "isOverall": false, "label": "90th percentile", "isController": false}, {"data": [[1.76400216E12, 96.95000000000005]], "isOverall": false, "label": "99th percentile", "isController": false}, {"data": [[1.76400216E12, 8.0]], "isOverall": false, "label": "95th percentile", "isController": false}, {"data": [[1.76400216E12, 3.0]], "isOverall": false, "label": "Min", "isController": false}, {"data": [[1.76400216E12, 4.0]], "isOverall": false, "label": "Median", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76400216E12, "title": "Response Time Percentiles Over Time (successful requests only)"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 192.0, "maxY": 4.0, "series": [{"data": [[192.0, 3.0], [200.0, 4.0], [208.0, 4.0]], "isOverall": false, "label": "Successes", "isController": false}, {"data": [[192.0, 2.0], [200.0, 2.0], [208.0, 3.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 208.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 192.0, "maxY": 4.0, "series": [{"data": [[192.0, 3.0], [200.0, 4.0], [208.0, 4.0]], "isOverall": false, "label": "Successes", "isController": false}, {"data": [[192.0, 2.0], [200.0, 2.0], [208.0, 3.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 208.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 33.333333333333336, "minX": 1.76400216E12, "maxY": 33.333333333333336, "series": [{"data": [[1.76400216E12, 33.333333333333336]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76400216E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 15.0, "minX": 1.76400216E12, "maxY": 18.333333333333332, "series": [{"data": [[1.76400216E12, 18.333333333333332]], "isOverall": false, "label": "200", "isController": false}, {"data": [[1.76400216E12, 15.0]], "isOverall": false, "label": "400", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76400216E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 1.6666666666666667, "minX": 1.76400216E12, "maxY": 16.666666666666668, "series": [{"data": [[1.76400216E12, 1.6666666666666667]], "isOverall": false, "label": "Transaction Controller-success", "isController": true}, {"data": [[1.76400216E12, 15.0]], "isOverall": false, "label": "Transaction Controller-failure", "isController": true}, {"data": [[1.76400216E12, 15.0]], "isOverall": false, "label": "Checkout-failure", "isController": false}, {"data": [[1.76400216E12, 16.666666666666668]], "isOverall": false, "label": "Add to Cart-success", "isController": false}, {"data": [[1.76400216E12, 1.6666666666666667]], "isOverall": false, "label": "Checkout-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76400216E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 20.0, "minX": 1.76400216E12, "maxY": 30.0, "series": [{"data": [[1.76400216E12, 20.0]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [[1.76400216E12, 30.0]], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76400216E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
