...
var responseTimeDistributionInfos = {
        data: {"result": {"minY": 2.0, "minX": 0.0, "maxY": 998.0, "series": [{"data": [[0.0, 998.0], [100.0, 2.0]], "isOverall": false, "label": "Checkout", "isController": false}, {"data": [[0.0, 992.0], [100.0, 8.0]], "isOverall": false, "label": "Add to Cart", "isController": false}, {"data": [[0.0, 987.0], [100.0, 9.0], [200.0, 4.0]], "isOverall": false, "label": "Transaction Controller", "isController": true}], "supportsControllersDiscrimination": true, "granularity": 100, "maxX": 200.0, "title": "Response Time Distribution"}},
        getOptions: function() {
...
var activeThreadsOverTimeInfos = {
        data: {"result": {"minY": 1.4530000000000027, "minX": 1.76412582E12, "maxY": 1.4530000000000027, "series": [{"data": [[1.76412582E12, 1.4530000000000027]], "isOverall": false, "label": "Scenario 1", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76412582E12, "title": "Active Threads Over Time"}},
        getOptions: function() {
            return {
                series: {
                    stack: true,
...
var timeVsThreadsInfos = {
        data: {"result": {"minY": 2.1922663802363083, "minX": 1.0, "maxY": 219.0, "series": [{"data": [[8.0, 9.0], [2.0, 3.9210526315789465], [9.0, 51.5], [10.0, 78.0], [11.0, 17.0], [12.0, 28.5], [3.0, 62.0], [13.0, 49.0], [14.0, 31.0], [15.0, 39.5], [16.0, 42.0], [4.0, 24.0], [1.0, 2.1922663802363083], [17.0, 36.0], [18.0, 56.5], [19.0, 23.0], [20.0, 36.0], [5.0, 103.0], [6.0, 96.0], [7.0, 96.0]], "isOverall": false, "label": "Checkout", "isController": false}, {"data": [[1.415, 3.602999999999998]], "isOverall": false, "label": "Checkout-Aggregated", "isController": false}, {"data": [[16.0, 48.75], [2.0, 5.333333333333333], [1.0, 3.757512953367874], [17.0, 14.0], [18.0, 23.5], [19.0, 74.33333333333333], [20.0, 95.5], [10.0, 5.0], [5.0, 5.0], [12.0, 5.0], [14.0, 9.0], [7.0, 5.0]], "isOverall": false, "label": "Add to Cart", "isController": false}, {"data": [[1.5240000000000005, 5.582999999999998]], "isOverall": false, "label": "Add to Cart-Aggregated", "isController": false}, {"data": [[8.0, 14.0], [2.0, 9.046511627906979], [9.0, 113.5], [10.0, 201.0], [11.0, 30.0], [12.0, 48.5], [3.0, 83.0], [13.0, 92.0], [14.0, 61.0], [15.0, 72.0], [16.0, 179.0], [4.0, 29.0], [1.0, 5.883369330453566], [17.0, 91.0], [18.0, 163.5], [19.0, 113.0], [20.0, 110.66666666666667], [5.0, 164.0], [6.0, 219.0], [7.0, 190.5]], "isOverall": false, "label": "Transaction Controller", "isController": true}, {"data": [[1.4199999999999988, 9.186]], "isOverall": false, "label": "Transaction Controller-Aggregated", "isController": true}], "supportsControllersDiscrimination": true, "maxX": 20.0, "title": "Time VS Threads"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var bytesThroughputOverTimeInfos = {
        data : {"result": {"minY": 12028.216666666667, "minX": 1.76412582E12, "maxY": 13829.766666666666, "series": [{"data": [[1.76412582E12, 12028.216666666667]], "isOverall": false, "label": "Bytes received per second", "isController": false}, {"data": [[1.76412582E12, 13829.766666666666]], "isOverall": false, "label": "Bytes sent per second", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76412582E12, "title": "Bytes Throughput Over Time"}},
        getOptions : function(){
            return {
                series: {
                    lines: {
...
var responseTimesOverTimeInfos = {
        data: {"result": {"minY": 3.602999999999998, "minX": 1.76412582E12, "maxY": 9.186, "series": [{"data": [[1.76412582E12, 3.602999999999998]], "isOverall": false, "label": "Checkout", "isController": false}, {"data": [[1.76412582E12, 5.582999999999998]], "isOverall": false, "label": "Add to Cart", "isController": false}, {"data": [[1.76412582E12, 9.186]], "isOverall": false, "label": "Transaction Controller", "isController": true}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76412582E12, "title": "Response Time Over Time"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var latenciesOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.76412582E12, "maxY": 5.551, "series": [{"data": [[1.76412582E12, 3.5780000000000056]], "isOverall": false, "label": "Checkout", "isController": false}, {"data": [[1.76412582E12, 5.551]], "isOverall": false, "label": "Add to Cart", "isController": false}, {"data": [[1.76412582E12, 0.0]], "isOverall": false, "label": "Transaction Controller", "isController": true}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76412582E12, "title": "Latencies Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var connectTimeOverTimeInfos = {
        data: {"result": {"minY": 0.0, "minX": 1.76412582E12, "maxY": 0.7020000000000007, "series": [{"data": [[1.76412582E12, 0.0]], "isOverall": false, "label": "Checkout", "isController": false}, {"data": [[1.76412582E12, 0.7020000000000007]], "isOverall": false, "label": "Add to Cart", "isController": false}, {"data": [[1.76412582E12, 0.7020000000000007]], "isOverall": false, "label": "Transaction Controller", "isController": true}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76412582E12, "title": "Connect Time Over Time"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var responseTimeVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 58.0, "maxY": 5.0, "series": [{"data": [[141.0, 5.0], [199.0, 4.0], [198.0, 3.0], [201.0, 4.0], [200.0, 4.0], [202.0, 3.0], [58.0, 3.0]], "isOverall": false, "label": "Successes", "isController": false}, {"data": [[199.0, 2.0], [198.0, 2.0], [201.0, 2.0], [200.0, 2.0], [202.0, 2.0], [58.0, 2.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 202.0, "title": "Response Time Vs Request"}},
    getOptions: function() {
        return {
            series: {
                lines: {
...
var latenciesVsRequestInfos = {
    data: {"result": {"minY": 2.0, "minX": 58.0, "maxY": 5.0, "series": [{"data": [[141.0, 5.0], [199.0, 4.0], [198.0, 3.0], [201.0, 4.0], [200.0, 4.0], [202.0, 3.0], [58.0, 3.0]], "isOverall": false, "label": "Successes", "isController": false}, {"data": [[199.0, 2.0], [198.0, 2.0], [201.0, 2.0], [200.0, 2.0], [202.0, 2.0], [58.0, 2.0]], "isOverall": false, "label": "Failures", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 1000, "maxX": 202.0, "title": "Latencies Vs Request"}},
    getOptions: function() {
        return{
            series: {
                lines: {
...
var hitsPerSecondInfos = {
        data: {"result": {"minY": 33.333333333333336, "minX": 1.76412582E12, "maxY": 33.333333333333336, "series": [{"data": [[1.76412582E12, 33.333333333333336]], "isOverall": false, "label": "hitsPerSecond", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76412582E12, "title": "Hits Per Second"}},
        getOptions: function() {
            return {
                series: {
                    lines: {
...
var codesPerSecondInfos = {
        data: {"result": {"minY": 15.0, "minX": 1.76412582E12, "maxY": 18.333333333333332, "series": [{"data": [[1.76412582E12, 18.333333333333332]], "isOverall": false, "label": "200", "isController": false}, {"data": [[1.76412582E12, 15.0]], "isOverall": false, "label": "400", "isController": false}], "supportsControllersDiscrimination": false, "granularity": 60000, "maxX": 1.76412582E12, "title": "Codes Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var transactionsPerSecondInfos = {
        data: {"result": {"minY": 1.6666666666666667, "minX": 1.76412582E12, "maxY": 16.666666666666668, "series": [{"data": [[1.76412582E12, 1.6666666666666667]], "isOverall": false, "label": "Transaction Controller-success", "isController": true}, {"data": [[1.76412582E12, 15.0]], "isOverall": false, "label": "Transaction Controller-failure", "isController": true}, {"data": [[1.76412582E12, 15.0]], "isOverall": false, "label": "Checkout-failure", "isController": false}, {"data": [[1.76412582E12, 16.666666666666668]], "isOverall": false, "label": "Add to Cart-success", "isController": false}, {"data": [[1.76412582E12, 1.6666666666666667]], "isOverall": false, "label": "Checkout-success", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76412582E12, "title": "Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
...
var totalTPSInfos = {
        data: {"result": {"minY": 20.0, "minX": 1.76412582E12, "maxY": 30.0, "series": [{"data": [[1.76412582E12, 20.0]], "isOverall": false, "label": "Transaction-success", "isController": false}, {"data": [[1.76412582E12, 30.0]], "isOverall": false, "label": "Transaction-failure", "isController": false}], "supportsControllersDiscrimination": true, "granularity": 60000, "maxX": 1.76412582E12, "title": "Total Transactions Per Second"}},
        getOptions: function(){
            return {
                series: {
                    lines: {
