    ...
    return (
        <div className="h-screen flex flex-col font-sans bg-[#fafafa] p-6 md:p-10 pt-0 overflow-y-auto">
            <div className="max-w-8xl mx-auto w-full">
                ...
                {cartItems.length === 0 && !successMsg && !error ? (
                                                    ...
                                                    <tr key={item.cart_item_id} className="hover:bg-slate-50 transition-colors">
                                                        <td className="px-6 py-4">
                                                            <div className="flex items-center gap-4">
                                                                <div className="w-16 h-20 bg-slate-200 rounded flex-shrink-0 overflow-hidden relative border border-slate-200">
                                                                    {item.image_url ? (
                                                                        <img 
                                                                            src={item.image_url} 
                                                                            alt={item.card_name} 
                                ...
                                <div className="w-full lg:w-80 flex-shrink-0">
                                    <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6 sticky top-10">
                                        ...
                                        <button 
                                            ...
                                            className={`w-full py-3 rounded-lg font-medium shadow-sm transition-all flex justify-center items-center
                                                ${processing 
